...
def item_payloads() -> list[dict[str, Any]]:
    ...
    items = [
        ...
        },
        {
            ...
            "category": "Gauntlets",
            "rank": "D",
            "description": "Heavy iron gloves that reinforce the wearer's strength.",
            "price": "750 CP",
            "weight": 4,
            "attributes": {},
            "tags": [],
            "augmentation_templates": [
                augmentation(
                    "iron_gauntlets_strength",
                    "Iron Gauntlets Strength",
                    root="instance",
                    path=["stats", "strength"],
                    effect=direct_effect("add", "3"),
                )
            ],
            "action_grants": [],
        },
        {
            ...
            "category": "Bracers",
            "rank": "E",
            "description": "Weighted bracers that provide a smaller stacking strength bonus.",
            "price": "200 CP",
            "weight": 2,
            "attributes": {},
            "tags": [],
            "augmentation_templates": [
                augmentation(
                    "training_bracers_strength",
                    "Training Bracers Strength",
                    root="instance",
                    path=["stats", "strength"],
                    effect=direct_effect("add", "1"),
                )
            ],
            "action_grants": [],
        },
        {
            "id": "weighted_greaves",
            "name": "Weighted Greaves",
            "interaction_type": "equippable",
            "category": "Heavy Armor",
            "rank": "D",
            "description": "Training greaves that trade dexterity for conditioning.",
            "price": "600 CP",
            "weight": 8,
            "attributes": {},
            "tags": [],
            "augmentation_templates": [
                augmentation(
                    "weighted_greaves_dexterity",
                    "Weighted Greaves Dexterity",
                    root="instance",
    ...
    *,
    ...
    requests.extend(
        [
            ...
            {
                "type": "record_kill",
                "kill_id": "seed_example_2_zombie_patrol",
                "credited_instance_id": SHADOWBLADE_INSTANCE_ID,
                "monster_name": "Zombie",
                "base_xp": 5,
                "quantity": 25,
                "occurred_at": "2026-07-01T19:25:00+00:00",
                "notes": "First wave cleared outside the gate.",
            },
            {
                "type": "record_kill",
                "kill_id": "seed_example_2_zombie_horde",
                "credited_instance_id": SHADOWBLADE_INSTANCE_ID,
                "monster_name": "Zombie",
                "base_xp": 5,
                "quantity": 20,
                "occurred_at": "2026-07-01T19:40:00+00:00",
                "notes": "Second wave cleared in the courtyard.",
            },
            {
                "type": "record_kill",
                "kill_id": "seed_example_2_zombie_cellar",
                "credited_instance_id": SHADOWBLADE_INSTANCE_ID,
                "monster_name": "Zombie",
                "base_xp": 5,
                "quantity": 15,
                "occurred_at": "2026-07-01T20:05:00+00:00",
                "notes": "Remaining undead cleared from the cellar.",
            },
            {
                "type": "record_kill",
                "kill_id": "seed_example_2_skeleton_crypt",
                "credited_instance_id": SHADOWBLADE_INSTANCE_ID,
                "monster_name": "Skeleton",
                "base_xp": 10,
                "quantity": 12,
                "occurred_at": "2026-07-02T18:30:00+00:00",
                "notes": "Crypt entrance guardians.",
            },
            {
                "type": "record_kill",
                "kill_id": "seed_example_2_skeleton_vault",
                "credited_instance_id": SHADOWBLADE_INSTANCE_ID,
                "monster_name": "Skeleton",
                "base_xp": 10,
                "quantity": 8,
                "occurred_at": "2026-07-02T18:50:00+00:00",
                "notes": "Vault guardians.",
            },
            {
                "type": "record_kill",
                "kill_id": "seed_example_2_cave_rats",
                "credited_instance_id": SHADOWBLADE_INSTANCE_ID,
                "monster_name": "Cave Rat",
                "base_xp": 1,
                "quantity": 40,
                "occurred_at": "2026-07-03T17:00:00+00:00",
                "notes": "A single large nest recorded as one batch.",
            },
        ]
    )
    return requests
