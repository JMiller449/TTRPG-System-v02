...
EXPECTED_ROUTE_MINIMUM_ROLES = {
    ...
    "reset_subject_attribute_value": "dm",
    ...
    "update_attribute": "dm",
    "update_item": "dm",
    "update_item_template": "dm",
    "update_tag": "dm",
    "update_kill": "dm",
    "update_instanced_sheet_action_bridge": "dm",
    "update_instanced_sheet_item_bridge": "dm",
    "update_instanced_sheet_proficiency_bridge": "dm",
...
EXPECTED_CUSTOM_DENIAL_REASONS = {
    ...
    "create_instanced_sheet_item_bridge": "Only a DM can edit equipment.",
    "create_instanced_sheet_proficiency_bridge": "Only a DM can edit proficiencies.",
    ...
    "delete_instanced_sheet_item_bridge": "Only a DM can edit equipment.",
    "move_instanced_sheet_item": "Authenticate first to manage character inventory.",
    "delete_instanced_sheet_proficiency_bridge": "Only a DM can edit proficiencies.",
    ...
    "set_instanced_sheet_item_equipped": "Authenticate first to manage character inventory.",
    "set_instanced_sheet_resistances": "Only a DM can edit sheet stats.",
    ...
    "set_sheet_resistances": "Only a DM can edit sheet stats.",
    ...
    "update_instanced_sheet_item_bridge": "Only a DM can edit equipment.",
    "update_instanced_sheet_proficiency_bridge": "Only a DM can edit proficiencies.",
