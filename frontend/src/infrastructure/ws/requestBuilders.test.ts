...
import {
  ...
  buildDeleteInstancedSheetProficiencyBridgeRequest,
...
const requestBuilderByType = {
  ...
  create_catalog_folder: buildCreateCatalogFolderRequest,
  ...
  create_instanced_sheet_action_bridge: buildCreateInstancedSheetActionBridgeRequest,
  create_instanced_sheet_item_bridge: buildAttachInstancedSheetItemRequest,
  create_instanced_sheet_proficiency_bridge: buildCreateInstancedSheetProficiencyBridgeRequest,
  create_item: buildCreateItemRequest,
  create_item_template: buildCreateItemTemplateRequest,
  ...
  create_sheet_from_instance: buildCreateSheetFromInstanceRequest,
  ...
  create_tag: buildCreateTagRequest,
  delete_action: buildDeleteActionRequest,
  delete_catalog_folder: buildDeleteCatalogFolderRequest,
  ...
  delete_item_template: buildDeleteItemTemplateRequest,
  ...
  delete_instanced_sheet_proficiency_bridge: buildDeleteInstancedSheetProficiencyBridgeRequest,
  delete_proficiency: buildDeleteProficiencyRequest,
  delete_sheet: buildDeleteSheetRequest,
  detach_instanced_sheet_attribute: buildDetachInstancedSheetAttributeRequest,
  ...
  delete_tag: buildDeleteTagRequest,
  ...
  set_contribution_points: buildSetContributionPointsRequest,
  set_pinned_instance_actions: buildSetPinnedInstanceActionsRequest,
  ...
  update_item_template: buildUpdateItemTemplateRequest,
  ...
  update_tag: buildUpdateTagRequest,
